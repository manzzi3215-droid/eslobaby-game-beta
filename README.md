...
현재 버전은 **v0.10.6-beta — 페이지별 AI 안내 음성(PAGE 1~14) 적용(총 14페이지)**입니다.
(각 PAGE 진입 시 해당 음성 1회 재생, 이동 시 이전 음성 즉시 정지. PAGE5 음성→울음·PAGE10 음성→웃음 순차. 영상 페이지(6·11)는 음성+영상 동시 재생. 효과음 유지, 반복 BGM 없음. 음원은 `assets/audio/voice/page01~14.m4a`)
