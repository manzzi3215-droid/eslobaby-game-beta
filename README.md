...
현재 버전은 **v0.9.3-beta — Page1 "?" 연출·STEP 번호 정정·필수 시청 영상·Page7 확대·Page10 배지 삭제·모바일 로고 하단 이동**입니다.
(Page1 아이 양옆 "?" 둥실 모션 · STEP 배지 1→2→3→4→5 정정 · Page6·11 영상은 끝까지 봐야 다음 이동(필수 시청, Page11=prof_nongye.mp4) · Page7 제품/제품명/키워드 확대 및 제품 중심 배치 · Page10 파란 배지 삭제 · 상단 안내문 축소 · 모바일 브랜드 로고를 하단 컨트롤 위 중앙으로 이동)
(직전 v0.9.2-beta: 마지막 페이지 가로 겹침·모바일 로고·컨트롤 정렬 / v0.9.1-beta: PAGE 6→7 전환 수정 / v0.8.0-beta: 총 13페이지)
