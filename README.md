...
현재 버전은 **v0.7.0-beta — STEP1 흐름 확장 · 계면이 배치 개선 · 계면활성제 설명 영상 페이지**입니다.
(STEP1 일반 바디워시 안내 페이지 추가, normal_wash/washhead 이미지·문구, 계면이 안전 슬롯 분산,
 PAGE 5 계면이 연출, residue→prof.mp4 영상 페이지, "자극을 유발해요!" 강조 흔들림)
(직전 v0.6.x: KEY COLOR #6DA1FF 디자인 · 욕실 배경 · PAGE1 비교 이미지)
