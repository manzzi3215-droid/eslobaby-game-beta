...
현재 버전은 **v0.10.5-beta — 전체 BGM 제거, PAGE 3·4·8·9 드래그 하단 그립, PAGE 6·11 영상 사이니지 호환 재인코딩+재생실패 fallback(총 14페이지)**입니다.
(효과음은 유지 — PAGE5 울음·PAGE10 웃음은 Web Audio 합성. 반복 BGM은 삭제. 영상은 삼성 사이니지 호환을 위해 H.264 Baseline·저비트레이트로 재인코딩)
