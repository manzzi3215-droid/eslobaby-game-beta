...
현재 버전은 **v0.8.0-beta — 신규 페이지 2개 추가(생분해 설명·Before/After 비교) + 화면 개선(총 13페이지)**입니다.
(PAGE 10-1 생분해 설명 placeholder 페이지, PAGE 10-2 비포/애프터 비교, PAGE 5·7·8·9·10 문구·이미지·강조 개선)
(직전 v0.7.0-beta: STEP1 흐름 확장 · 계면이 안전 슬롯 · 계면활성제 설명 영상 페이지)
